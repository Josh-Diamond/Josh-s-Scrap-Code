...
export default function SearchBar() {
    return (
        <div className={css({ width: '250px', height: '50px', borderRadius: '6px', backgroundColor: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 99})}>
          <input placeholder='Search location or pump' className={css({ color: '#082B84', fontWeight: 'bold', margin: '2%', border: 'none', outline: 'none', width: '100%', "::placeholder": { color: '#7E7E7E', fontWeight: '100'} })} />
